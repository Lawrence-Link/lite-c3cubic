...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_label_set_text(ui->screen_1_label_1, "LVGL8");
	lv_label_set_long_mode(ui->screen_1_label_1, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_1_label_1, 52, 116);
	lv_obj_set_size(ui->screen_1_label_1, 137, 32);
	...
	lv_obj_set_style_text_font(ui->screen_1_label_1, &lv_font_montserratMedium_35, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_1_label_2, "Powered by\n");
	lv_label_set_long_mode(ui->screen_1_label_2, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_1_label_2, 61, 88);
	lv_obj_set_size(ui->screen_1_label_2, 119, 17);
	...
	lv_obj_set_style_radius(ui->screen_1_label_2, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
