 ...
 * Size: 22 px
 * Bpp: 4
 * Opts: --user-data-dir=C:\Users\Lawre\AppData\Roaming\gui-guider --app-path=D:\Program Files\NXP\GUI-Guider-1.7.2-GA\resources\app.asar --no-sandbox --no-zygote --lang=zh-CN --device-scale-factor=1.5 --num-raster-threads=4 --enable-main-frame-before-activation --renderer-client-id=5 --time-ticks-at-unix-epoch=-1715391110262647 --launch-time-ticks=10071879273 --mojo-platform-channel-handle=2980 --field-trial-handle=1728,i,4399375344041102312,5803742161046550907,131072 --disable-features=SpareRendererForSitePerProcess,WinRetrieveSuggestionsOnlyOnDemand /prefetch:1
 ******************************************************************************/
